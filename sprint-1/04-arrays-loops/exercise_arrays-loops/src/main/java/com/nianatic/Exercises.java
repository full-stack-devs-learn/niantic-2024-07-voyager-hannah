...
public class Exercises {
    ...
    public boolean hasName(String[] names, String nameToFind) {
        String lowerCaseNameToSearch = nameToFind.toLowerCase();
        for (String name : names) {
            if (name.toLowerCase().equals(lowerCaseNameToSearch)) return true;
        }
        return false;
    }
     ...
     */
    public static int countName(String[] names, String nameToSearch) {
        String lowerCaseNameToSearch = nameToSearch.toLowerCase();
        int countName = 0;
        for (String name : names) {
            if (name.toLowerCase().equals(lowerCaseNameToSearch)) {
                countName++;
            }
            }
    ...
    public int sumNumbers(int[] numbers) {
        ...
        public int doubleEvens ( int[] numbers) {
            int doubleEvensSum = 0;
            for (int number : numbers) {
                if (number % 2 == 0) {
                    doubleEvensSum += number;
                }
            }
                    return doubleEvensSum * 2;
        ...
        public int sumEveryThird ( int[] numbers){
            ...
            for(int i = 0;i < numbers.length; i++ ) {
                if (i % 3 == 0) {
                    sumEveryThird += numbers[i];
                }

            }
            return sumEveryThird;
        }
        ...
        public double averagePrice ( double[] prices){
            ...
            return averagePrice / prices.length;
            }
